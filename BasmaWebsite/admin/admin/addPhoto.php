    ...
    <section class="cover">
        <div class="page-wrapper">
            <div class="page-header">
                <h1 class="page-title">إضافة صورة جديدة</h1>
            ...
            <div class="form-card">
                <form action="../logic/addPhoto_logic.php" method="post" enctype="multipart/form-data">
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <select name="categoryName" class="form-select" required>
                                ...
                                <option value="ما بعد القصف">ما بعد القصف</option>
                                <option value="صرخات الجوع">صرخات الجوع</option>
                            </select>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">عنوان الصورة</label>
                            <input type="text" name="title" class="form-control" placeholder="ادخل عنوان الصورة"
                                required />
                        </div>
                    </div>
                    <div class="col-12">
                        <label class="form-label">وصف الصورة</label>
                        <textarea name="details" rows="8" class="form-control" placeholder="اكتب تفاصيل الصورة كاملة"
                            required></textarea>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="actions">
                        <button type="submit" name="save_photo" class="btn-save">
